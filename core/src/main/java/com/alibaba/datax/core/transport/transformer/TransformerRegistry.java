...
public class TransformerRegistry {
    ...
    static {
        ...
        registTransformer(new StringReplaceTransformer());
        registTransformer(new StringInterceptTransformer());
        registTransformer(new NullReplaceTransformer());
        registTransformer(new DateConverterTransformer());
        registTransformer(new ConstTransFormer());
        registTransformer(new BlankReplaceTransformer());
        registTransformer(new AddTimeStampTransformer());
        registTransformer(new LineBreakReplaceTransformer());
    }
